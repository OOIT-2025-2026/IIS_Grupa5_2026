...
public class FrmTest extends JFrame {
	...
	public FrmTest() {
		...
		btnKlikniMe.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Antistres dugme :)", "Proba", JOptionPane.INFORMATION_MESSAGE);
			}
		});
		...
		JButton btnBojaPozadine = new JButton("Pozadina");
